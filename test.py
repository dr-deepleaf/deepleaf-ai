...
# 모델 로드
model_main = tf.keras.models.load_model("./model/fourth_trained_model.keras")
tomato_model = tf.keras.models.load_model("./model/tomato_trained_model.keras")
corn_model = tf.keras.models.load_model("./model/corn_trained_model.keras")
grape_model = tf.keras.models.load_model("./model/grape_trained_model.keras")
orange_watermelon_model = tf.keras.models.load_model("./model/orange_watermelon_trained_model.keras")
...
async def health_check():
    """
    로드밸런서(ALB) 상태 검사 및 현재 인스턴스 IP 확인
    """
    # 현재 서버의 호스트네임을 가져와서 IP로 변환
